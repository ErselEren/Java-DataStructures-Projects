...
/**
 * Street class with created bu using LinkedList
 */
public class LL_Street {
    protected LinkedList<Building> left;
    protected LinkedList<Building> right;
    ...
    private LinkedList<LinkedList<Integer>> sillhouette;


    LL_Street(){
        length_of_street = 100;
        left = new LinkedList<Building>();
        right = new LinkedList<Building>();
    }
    ...
    */
    private void fill_sillhoutte(){
        ...
        int max_height = find_max_height();
        sillhouette = new LinkedList<LinkedList<Integer>>();
        for(int i=0;i<max_height+2;i++){
            sillhouette.add(new LinkedList<Integer>());
    ...
    */
    private void add_process(Building newBuilding, LinkedList<Building> street){          
    ...
    */
    private void delete_process(LinkedList<Building> street){  
