...
public class Street{
    protected Building[] left; //stores buildings of left side of street
    protected Building[] right; //stores buildings of right side of street
    ...
    private Building newBuild; //Building reference for adding new building
    ...
    public void list_of_buildings(){
        ...
        for(int i=0;i<left.length;i++){
            ...
            else if(left[i] instanceof Playground) playground++;
        }
        ...
        for(int i=0;i<right.length;i++){
            ...
            else if(right[i] instanceof Playground) playground++;
        }
    ...
    public void playground_ratio(){
        ...
        for(int i=0;i<left.length;i++){
            if(left[i] instanceof Playground){
                playground_count++;
        ...
        //counting playground buildings by using instanceof
        for(int i=0;i<right.length;i++){
            if(right[i] instanceof Playground){
                playground_count++;
    ...
    public void add_building() throws Exception{
        ...
        try{
            ...
            else if(building.compareTo("playground")==0) newBuild = new Playground();
     ...
     */
    private Building[] add_process(Building newBuild, Building[] street, int[] control_array){
        Building[] temp;
        ...
        if(street == null){
            ...
            temp = new Building[street.length+1];
     ...
     */
    private boolean find_space(int[] street, Building build){
     ...
     */
    private Building[] delete_process(Building[] street, int[] control_array){
        Building[] temp = new Building[street.length-1];
