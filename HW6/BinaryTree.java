...
public class BinaryTree<E> implements Serializable {
	...
	protected static class Node<E> implements Serializable {
		...
		public BinaryTree.Node<E> getRight() {
			return right;
		}

		public BinaryTree.Node<E> getLeft() {
			return left;
		}
        ...
        public int compareTo(Object o) {
            ...
            return ((Comparable<E>) temp).compareTo(data);
        }

	}

	public static class InorderIterator<E> implements Iterator<Node<E>> {
		...
		public void fillList(Node<E> currentNode) {
