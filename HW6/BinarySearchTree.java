...
public class BinarySearchTree<E> extends BinaryTree<E> implements SearchTree<E>{
	...
	private Node<E> add(Node<E> localRoot, E item){
		if(localRoot == null){
			...
			int compare = ((Comparable<E>) item).compareTo(localRoot.data);
			if (compare == 0){
	...
	@SuppressWarnings("unchecked")
	public void iterate(LinkedList<E> list){
		InorderIterator<E> it = new InorderIterator<E>((BinaryTree.Node<E>) root);
